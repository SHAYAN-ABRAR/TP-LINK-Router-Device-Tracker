...
def scrape_router_info(status_url, dhcp_url):
    ...
    Returns:
        dict: A dictionary containing router information for Status, LAN, Wireless, WAN, and Connected Devices,
    ...
    try:
            ...
            for table in tables:
                ...
                for i, row in enumerate(rows[1:], 1):  # Skip header row, start from 1
                    ...
                    if len(cells) >= 4:  # Expecting at least Client Name, IP, MAC, Lease Time
                        ...
                        # Enhanced filter to exclude invalid entries (all Not Found or single '0' with others Not Found)
        ...
        # Print router information in the specified document format
        print("<DOCUMENT>")
...
# Example usage for TL-WR720N_V2
